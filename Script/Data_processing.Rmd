...
gene_count_matrix_auto <- read.table("Data/Raw_data/Gene_count_matrix_ENS_HGCN_auto.txt", header = TRUE, row.names = 1)
gene_count_matrix_B <- read.table("Data/Raw_data/Gene_count_matrix_ENS_HGCN_B.txt", header = TRUE, row.names = 1)
