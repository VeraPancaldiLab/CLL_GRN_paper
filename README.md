...
The **Results** directory contains the processed outputs from various computational analyses conducted in this project. 
Each subfolder corresponds to a specific analytical method and is directly associated with the script(s) (*Scripts/*) responsible for generating the results, ensuring full reproducibility. Below is the structured mapping of results to their corresponding scripts:  
 ...
 **msVIPER analysis** (`msVIPER/`)  
   - Generated by: `diff_analysis.R`, `DAA_msviper.Rmd`, `msVIPER.R`, `msVIPER.Rmd`, `extract_msViper_results.R`
